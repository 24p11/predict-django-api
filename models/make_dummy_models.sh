...
python make_dummy_model.py tensorflow_worker/tests/data/dummy_cmd_train_dataset.csv --model-dir models/crh_severity_model/
python make_dummy_sentence_model.py models/crh_severity_model/
